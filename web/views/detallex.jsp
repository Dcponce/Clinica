<%-- 
    Document   : detalle_expediente
    Created on : 07-24-2019, 09:57:33 AM
...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function nuevo(ide, idp, idc) {
                document.Agregar.txtpaciente.value = idp;
                document.Agregar.txtExp.value = ide;
                document.Agregar.txtPa.value = idc;
                document.Agregar.txtE.value = ide;
            }
        </script>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Lista de historial clinico</h6>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="nuevo">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../detalle.do" method="Post" name="Agregar">
                    <div class="modal-header">						
                        <h4 class="modal-title">Nuevo historial clinico</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" name="txtPa" class="form-control">
                            <label>Paciente</label>
                            <select class="form-control" name="txtpaciente" required disabled>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="txtE" class="form-control">
                            <label># Expediente </label>
                            <input type="text" name="txtExp" class="form-control" required disabled>
                        </div>
                        <div class="form-group">
                            <label>Diagnóstico</label>
                            <textarea rows="4" cols="50" name="txtDiag" class="form-control" required>
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label>Tratamiento</label>
                            <textarea rows="4" cols="50" name="txtTra" class="form-control" required>
                            </textarea>
                        </div>
                    </div>
