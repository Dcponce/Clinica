 ...
 */
public class Usuario2 extends HttpServlet {
            ...
            if (user.validar_usuario()) {
                ...
                switch (user.getLvl()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        response.sendRedirect("views/citas.jsp");
                        break;
                }
            } else {
                response.sendRedirect("views/login.jsp?error=true");
