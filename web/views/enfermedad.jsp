<%-- 
    Document   : enfermedad
    Created on : Jul 21, 2019, 11:14:08 PM
...
<html lang="en">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Nueva Enfermedad</h1>                            
                            <a href="#nuevo" class="btn btn-success btn-sm" data-toggle="modal">Crear Enfermedad</a>
                        </div>
    ...
    <div class="modal fade" id="nuevo">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../enfermedad.do" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="txtEf" class="form-control" required pattern="[A-Za-z]{}" title="Campo requiere letras">
                        </div> 
                    </div>
    ...
    <div class="modal fade" id="borrar">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../enfermedad.do?action=delete" method="Post">
                    <div class="modal-header">						
    ...
    <div class="modal fade" id="editar">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../enfermedad.do" method="Post" name="Update">
                    <div class="modal-header">						
