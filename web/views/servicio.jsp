<%-- 
    Document   : servicio
    Created on : Jul 21, 2019, 9:46:37 PM
...
<html lang="en">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="#nuevo" class="btn btn-success btn-sm" data-toggle="modal">Crear Servicio</a>
                        </div>
    ...
    <div class="modal fade" id="borrar">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../servicio.do?action=delete" method="Post">
                    <div class="modal-header">						
    ...
    <div class="modal fade" id="editar">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../servicio.do" method="Post" name="Update">
                    <div class="modal-header">						
